...
public class MuaBooking {
    ...
    public MuaBooking(String id, String service_id, String service_name, String mua_name, String user_id, String date, String time, String customer_name, String phone, String amount_person, String address, String total_price, String payment_proof, String status) {
        this.id = id;
