...
public class MuaReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mua_review);
    ...
    public void getData(){
        progressDialog = ProgressDialog.show(MuaReviewActivity.this,"Proses","Tunggu Sebentar. . .",false,false);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        Log.d(TAG, "onResponse: " + response);
                        {
                            try {
                                ...
                                ReviewAdapter adapter = new ReviewAdapter(MuaReviewActivity.this, dataReview);
